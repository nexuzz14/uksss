    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="tabels.php" class="active">
    ...
    <div class="card">
            <div class="card-body">
              ...
              <form action="" method="post">
                ...
                <div class="row mb-3">
                  <label name="nama" for="" class="col-sm-2 col-form-label">Siswa Sakit</label>
                    <div class="col-sm-7">
                         <input type="text" name="nama_siswa" class="form-control" id="inputText">
                    </div>
                </div>
                <div class="row mb-3">
                  <label name="nama" for="" class="col-sm-2 col-form-label">Obat</label>
                    <div class="col-sm-7">
                         <input type="text" name="nama_siswa" class="form-control" id="inputText">
                    </div>
                </div>
...
use LDAP\Result;
              ...
              if (isset($_POST['submit'])) {
                ...
                $kelas = $_POST['kelas'];
                $sql = "INSERT INTO kunjungan VALUES (null, '$id_siswa','$nama_siswa','$kelas')";
            ...
            <div class="card-body">
              ...
              <table class="table datatable table-striped table-bordered">
                ...
                <tbody>
                  ...
                  $result = mysqli_query($conn, "SELECT * FROM kunjungan  ");
