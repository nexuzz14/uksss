    ...
    <div class="card">
            <div class="card-body">
              ...
              <form action="" method="post">
                ...
                <div class="row mb-3">
                  <label name="username" for="" class="col-sm-2 col-form-label">Username</label>
                    <div class="col-sm-7">
                         <input type="text" name="username" class="form-control" id="inputText">
                    </div>
                </div>
                <div class="row mb-3">
                  <label name="username" for="" class="col-sm-2 col-form-label">Password</label>
                    <div class="col-sm-7">
...
use LDAP\Result;
              ...
              if (isset($_POST['submit'])) {
                ...
                $sql = "INSERT INTO petugas VALUES (null, '$fullname','$username','$password')";
                ...
                <tbody>
                  ...
                  while($row = mysqli_fetch_assoc($result)) {
                    ...
                    <tr>
                      ...
                      <td >
                        <a href="editdatasp.php?id=<?php echo $row['id'];?>">
